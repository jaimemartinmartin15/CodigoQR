export const CSS_CLASSES = {
  ...
  SELECTED_ERROR_CAPACITY_LEVEL: '.selected-error-capacity-level',
  ...
  ERROR_CAPACITY_CODIFICATION_BITS: '.error-capacity-codification-bits',
  MASK_CODIFICATION_BITS: '.mask-codification-bits',

  FORMAT_INFORMATION_DATA_BITS: '.format-information-data-bits',
  FORMAT_INFORMATION_CORRECTION_BITS: '.format-information-correction-bits',
};

export const CSS_IDS = {
  GENERATE_QR_CODE_BUTTON: '#generate-qr-code-button',

  EMPTY_QR_CODE: '#empty-qr-code',
  QR_CODE_SECTIONS: '#qr-code-sections',
  GENERATED_FINAL_QR_CODE: '#generated-final-qr-code',
  HOW_TO_ENTER_DATA_EXPLANATION: '#how-to-enter-data-explanation',

  VERSIONS_TABLE: '#versions-table',
  ALIGNMENT_PATTERN_TABLE: '#alignment-pattern-table',
  ...
  INFORMATION_FORMAT_15_BITS: '#information-format-15-bits',
