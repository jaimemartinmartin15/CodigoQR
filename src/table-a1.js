export const TABLE_A1 = [
  { numberOfErrorCorrectionCodewords: 2, coeficients: [0, 25, 1] },
  { numberOfErrorCorrectionCodewords: 5, coeficients: [0, 113, 164, 166, 119, 10] },
  { numberOfErrorCorrectionCodewords: 6, coeficients: [0, 166, 0, 134, 5, 176, 15] },
  { numberOfErrorCorrectionCodewords: 7, coeficients: [0, 87, 229, 146, 149, 238, 102, 21] },
  { numberOfErrorCorrectionCodewords: 8, coeficients: [0, 175, 238, 208, 249, 215, 252, 196, 28] },
  { numberOfErrorCorrectionCodewords: 10, coeficients: [0, 251, 67, 46, 61, 118, 70, 64, 94, 32, 45] },
  { numberOfErrorCorrectionCodewords: 13, coeficients: [0, 74, 152, 176, 100, 86, 100, 106, 104, 130, 218, 206, 140, 78] },
  { numberOfErrorCorrectionCodewords: 14, coeficients: [0, 199, 249, 155, 48, 190, 124, 218, 137, 216, 87, 207, 59, 22, 91] },
  { numberOfErrorCorrectionCodewords: 15, coeficients: [0, 8, 183, 61, 91, 202, 37, 51, 58, 58, 237, 140, 124, 5, 99, 105] },
  { numberOfErrorCorrectionCodewords: 16, coeficients: [0, 120, 104, 107, 109, 102, 161, 76, 3, 91, 191, 147, 169, 182, 194, 225, 120] },
  { numberOfErrorCorrectionCodewords: 17, coeficients: [0, 43, 139, 206, 78, 43, 239, 123, 206, 214, 147, 24, 99, 150, 39, 243, 163, 136] },
  {
    numberOfErrorCorrectionCodewords: 18,
    coeficients: [0, 215, 234, 158, 94, 184, 97, 118, 170, 79, 187, 152, 148, 252, 179, 5, 98, 96, 153],
  },
  {
    numberOfErrorCorrectionCodewords: 20,
    coeficients: [0, 17, 60, 79, 50, 61, 163, 26, 187, 202, 180, 221, 225, 83, 239, 156, 164, 212, 212, 188, 190],
  },
  {
    numberOfErrorCorrectionCodewords: 22,
    coeficients: [0, 210, 171, 247, 242, 93, 230, 14, 109, 221, 53, 200, 74, 8, 172, 98, 80, 219, 134, 160, 105, 165, 231],
  },
  {
    numberOfErrorCorrectionCodewords: 24,
    coeficients: [0, 229, 121, 135, 48, 211, 117, 251, 126, 159, 180, 169, 152, 192, 226, 228, 218, 111, 0, 117, 232, 87, 96, 227, 21],
  },
  {
  ...
  },
  {
    ...
    coeficients: [
      0, 106, 120, 107, 157, 164, 216, 112, 116, 2, 91, 248, 163, 36, 201, 02, 229, 6, 144, 254, 155, 135, 208, 170, 209, 12, 139, 127, 142,
      182, 249, 177, 174, 190, 28, 10, 85, 239, 184, 101, 124, 152, 206, 96, 23, 163, 61, 27, 196, 247, 151, 154, 202, 207, 20, 61, 10,
    ],
  },
  {
